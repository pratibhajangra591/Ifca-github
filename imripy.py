...
# Definition of the halo profile 
...
## Definition of the merger system
...
## Definition of the binary inspiral
...
class HaloFeedback:
    ...
    """
    N_b = 50
    b_min = 15e3 * m_to_pc   # 15 km in pc
    m_grid_density = 6
    ...
    def dfHalo_dt(self, R, v_cut=None, t_scale=None):
        ...
        norm = np.simpson(HaloFeedback.P_DeltaEps(v_0, DeltaEps[0], b_90, b_min, b_max), x=DeltaEps[0])
        ...
        dfHalo += mp.simpson(    (Eps/EpspDeltaEps )**(5./2.)
